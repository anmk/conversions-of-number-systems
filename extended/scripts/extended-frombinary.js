...
function NumberSystems(numberToConvert, hex, dec, oct, nibbleSize) {
...
NumberSystems.prototype.fromBinary = function() {
  ...
  for(var i = 0; i < arrLength; i++) {
    ...
    if ((j > this._nibbleSize) && ((this._hex === true) || (this._oct === true))) {
  ...
  this._decimalArray = nibble.toString().split("");

  if (this._hex === true) {
      NumberSystems.prototype.hexResult.call(this, this._convertedArray);
  } else if (this._dec === true) {
      NumberSystems.prototype.decResult.call(this, this._decimalArray);
...
NumberSystems.prototype.decResult = function() {
  var info = "Decimal";
  var decimalArray = this._decimalArray;
  var decStr = decimalArray.toString().split("");
  var sLength = decStr.length;
  this.clean.call(this, decStr, sLength, info);
};
...
function ToHexadecimal(numberToConvert) {
  ...
  this._oct = false;
  this._nibbleSize = 3;
  NumberSystems.call(this, numberToConvert, this._hex, this._dec, this._oct, this._nibbleSize);
...
function ToDecimal(numberToConvert) {
  this._hex = false;
  this._dec = true;
  this._oct = false;
  this._nibbleSize = 1;
...
ToDecimal.prototype = Object.create(NumberSystems.prototype);
...
var toDecimal1 = new ToDecimal(binary);
